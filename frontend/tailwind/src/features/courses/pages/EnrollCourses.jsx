...
import { getUserEnrolledCourses } from "../../profile/profileAPI";
...
const EnrollCourses = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto text-slate-100 px-4 py-10 min-h-screen space-y-6">
            {/* Header */}
                    ...
                    {["All", "In Progress", "Completed"].map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-4 py-2 rounded-xl text-xs font-medium border transition ${filter === tab
                    ...
                    <div className="grid grid-cols-7 gap-1.5 text-center text-xs">
                        {Array.from({ length: 30 }).map((_, i) => {
                            ...
                            return (
                                <div
                                    key={day}
                                    className={`py-2 rounded-lg font-medium transition relative ${isToday
                ...
                <div className="grid grid-cols-1 gap-4">
                    {filteredCourses.map((course, idx) => {
                        ...
                        return (
                            <div
                                key={course._id || idx}
                                className={`group flex flex-col p-5 bg-gradient-to-b from-slate-900 to-slate-950 rounded-2xl border transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl space-y-4 ${isCurrentFocus ? "border-slate-700 bg-slate-900/90 ring-1 ring-slate-700/50" : "border-slate-800 hover:border-slate-700"
                                    }`}
